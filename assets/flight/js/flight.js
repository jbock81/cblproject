...
var strQuiz = {
    intro: "Would you like to play a flight?",
    quiz_main: [
        "What is 1 + 1?",
        "What is 2 + 2?",
        "What is 3 + 3?",
    ...
    correct: "Congratulations! You passed the flight 1.",
    wrong: "Oh, no!!!"
};
var back_img_cnt = 6;
var noRespond = 0;
var qz_order = [];
var qz_retries = []; // Maximum value is 2
var qz_states = []; //1: Correct, 2: Partially Correct, 3: Fully Incorrect
...
function initQuestions() {
    ...
    while(quiz_nums_main.length < 3){
        quiz_num = Math.floor((Math.random() * flight_qz_cnt) + 1);
        ...
        socket.onmessage = (message) => {
            ...
            if (transcript && received.is_final) {
                ...
                if (quizStatus == 1) {
                    ...
                    if (endRetrySpeech() && flight_passed == 0) {
                        quizStatus = 1;
                        initQuestions();
                    }
                }   
